...
const Community = () => {
  ...
  const fetchLeaders = async () => {
    const res = await axios.get('https://kilo-app-backend.onrender.com/api/users/leaderboard');
    setLeaders(res.data);
  };
        ...
        {filtered.map((post) => (
          ...
          >
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.7rem' }}>
              <img
                src={`https://kilo-app-backend.onrender.com/uploads/${post.avatar || 'default.png'}`}
                alt="avatar"
            ...
            {post.media && post.mediaType === 'image' && (
              <img
                src={`https://kilo-app-backend.onrender.com/uploads/${post.media}`}
                alt="media"
            ...
            {post.media && post.mediaType === 'video' && (
              <video controls style={{ width: '100%', borderRadius: '10px', marginTop: '1rem' }}>
                <source src={`https://kilo-app-backend.onrender.com/uploads/${post.media}`} />
              </video>
            )}
              ...
              {post.comments.map((c, i) => (
                <motion.div key={i} initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: i * 0.03 }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', marginTop: '0.4rem' }}>
                    <img
                      src={`https://kilo-app-backend.onrender.com/uploads/${c.avatar || 'default.png'}`}
                      alt="avatar"
